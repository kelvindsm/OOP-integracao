...
class MapLeaflet(Tag):
    def __init__(self, name_id, height="500px", width="100%", center_lat=-15.76, center_lon=-47.89, zoom_level=5,
                 attrs=None):
    ...
    def add_points_from_list(self, point_list, lat_field='latitude', lon_field='longitude', name_field=None,
                             popup_field=None):
